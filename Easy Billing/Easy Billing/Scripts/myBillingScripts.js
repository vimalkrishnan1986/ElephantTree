...
$(document).ready(function () {
    ...
    $('#submit').click(function () {
        ...
        $('#orderdetailsItems tbody tr').each(function (index, ele) {
            ...
            var orderItem = {
                Billing_number: ($('.purchaseNo').val()).toString(),
                Date: $('.orderDate').val(),
                ...
                success: function (data) {
                    if (data.status) {
                        ...
                        if ($('.chkrpt').is(":checked")) {
                            ...
                            window.open('http://localhost:8087/api/Billing/GetBillingListReport?Bllno=' + ($('.purchaseNo').val()).toString(), 'name', 'width=600,height=400');
                            a = "1";
                        }
